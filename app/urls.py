...
urlpatterns = [
    ...
    path('samples/<int:pk>/delete/', views.delete, name='sample_delete'),
    path('samples/<int:pk>/restore/', views.restore, name='sample_restore'),
    path('samples/<int:pk>/fully_used/', views.fully_used, name='sample_fully_used'),
