...
class Experiment(models.Model):
    ...
    last_modified_by = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="last_modified_experiments",
    )
...
class BasicScienceBox(models.Model):
    ...
    experiments = models.ManyToManyField(Experiment, related_name="boxes")
    ...
    def distinct_species(self):
        ...
        species_labels = {
            experiment.get_species_display() for experiment in self.experiments.all() if experiment.species
        }
    ...
    def basic_science_groups(self):
        ...
        groups = {experiment.basic_science_group for experiment in self.experiments.all()}
