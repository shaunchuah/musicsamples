...
def analytics(request):
    ...
    samples_by_month = Sample.objects.all().filter(is_deleted=False).annotate(sample_month=Trunc('sample_datetime', 'month')).order_by().values('sample_month').annotate(sample_count=Count('id'))
    context = {
