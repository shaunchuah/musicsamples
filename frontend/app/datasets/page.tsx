...
// Server-rendered wrapper for the datasets dashboard view and shared sidebar shell.
// Exists to provide authenticated access to datasets within the Next.js app layout.
